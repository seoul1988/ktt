...
export default function CommunityAttendeeRegistrationForm({
  ...
  const storageKey = `community-attendee-form-mode-${eventId}`;
  ...
  useEffect(() => {
    ...
    window.addEventListener("community-attendee-form-mode-change", handleModeChange);

    return () => {
      window.removeEventListener("community-attendee-form-mode-change", handleModeChange);
    };
  }, [eventId, storageKey]);
  ...
  function changeMode(nextMode: Mode) {
    ...
    window.dispatchEvent(
      new CustomEvent("community-attendee-form-mode-change", {
