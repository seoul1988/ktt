...
export default function CommunityBottomNav({
  ...
  const navButtonClass =
    "group flex h-full min-h-[68px] min-w-0 flex-1 touch-manipulation select-none [-webkit-tap-highlight-color:transparent] flex-col items-center justify-center gap-1 px-1 py-2 transition-[background-color,opacity] duration-150 active:bg-gray-100 active:opacity-90";
        ...
        >
          ...
          {isIOS && (
            <button
              ...
              onClick={handleBack}
              aria-label="Go back"
              className="group flex h-full min-h-[68px] flex-1 touch-manipulation select-none [-webkit-tap-highlight-color:transparent] flex-col items-center justify-center gap-1 px-1 py-2 text-[#172033] transition-[background-color,opacity] duration-150 active:bg-gray-100 active:opacity-90"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
                className="h-5 w-5 transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] will-change-transform group-active:-translate-y-0.5 group-active:scale-[1.12]"
                stroke="currentColor"
                strokeWidth="1.8"
                strokeLinecap="round"
              ...
              <span className="mt-0.5 text-[9px] font-medium leading-none transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] will-change-transform group-active:scale-[1.03]">
                Back
              </span>
            </button>
          )}
          ...
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
              className="h-6 w-6 transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] will-change-transform group-active:-translate-y-0.5 group-active:scale-[1.12]"
              stroke="currentColor"
              strokeWidth="1.8"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            <span className="text-[10px] font-medium leading-none transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] will-change-transform group-active:scale-[1.03]">
              Home
            </span>
          </Link>
          ...
          <div className="pointer-events-none absolute left-1/2 top-0 z-20 h-[72px] w-[84px] -translate-x-1/2">
            <Link
              ...
              className={`
                ...
                will-change-transform active:-translate-y-1 active:scale-[1.10]
                hover:scale-105
                ${
                  activeNav === "search"
            ...
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
                className="h-7 w-7 text-white transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] will-change-transform group-active:scale-[1.10]"
                stroke="currentColor"
                strokeWidth="2.2"
                strokeLinecap="round"
                strokeLinejoin="round"
