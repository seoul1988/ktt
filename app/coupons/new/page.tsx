...
export default function CouponsPage() {
  ...
  const groups = useMemo(() => {
    ...
    coupons.forEach((coupon) => {
      ...
      if (showFavoritesOnly && !favoriteBusinessIds.includes(business.id)) return;
          ...
          <div className="flex h-12 items-center justify-between px-4">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className={`relative flex h-9 w-9 items-center justify-center rounded-full text-[22px] transition ${
                  showFavoritesOnly
                    ? "bg-[#FFF0EF] text-[#EB4A45]"
                    : "text-[#8B9098]"
                }`}
